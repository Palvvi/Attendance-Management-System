...
if(isset($_POST["action"]))
  {
    ...
    {
      $deleteteacherseq=$_POST["seq"];

      $isDelete=TeacherDataStore::deleteteacherbyseq($deleteteacherseq);
...
<html lang="en">
  <head>
        ...
        <script type="text/javascript">
            ...
            function editteacher($seq)
            {
                
                $(".editingSeq").val($seq);
                $(".editingteacherForm").submit();
            }
            function deleteteacher($seq)
            {
  ...
  <body class="customBody">
    ...
    <?php include 'menu.php';?>
        ...
        <div class="row px-4 pt-4">
            ...
            <p id="updated-message" style="display:none" class="message">
                Teacher details has been updated succesfully.
            </p>
            ...
            <div class=" p-2 col customBody rounded text-primary-emphasis">
                <img src="images/teacherlist.png" alt="teacherlist" style="height:40px;">
            ...
            <div class="row p-4">
                <div class="col-9">
                    ...
                    <span class="fs-5">Total Teachers:- <?=$totalTeachers?></span>
                </div>
                <div class="col-3">
                    <a href="teacherdetail.php" style="text-decoration:none; color:black">
                        <img src="images/detail.png" alt="detail" height="30px">
                           ...
                           else
                           {
                            ...
                            foreach($teachers as $teacher) {  
                                ...
                                <tr>
                                    ...
                                    <td><a href="javascript:editteacher(<?=$teacher["seq"] ?>)" ><img src="images/edit.png" alt="edit" style="height:30px"/></a></td>
                                   
                                    <td><a href="javascript:deleteteacher(<?=$teacher["seq"] ?>)" ><img src="images/delete.png" alt="edit" style="height:30px"/></a></td>
...
if(isset($_GET["updated"]))
{
    ...
    {?>
        <script>
            $("#updated-message").show().delay(10000).fadeOut(500);
        </script>
      <?php
